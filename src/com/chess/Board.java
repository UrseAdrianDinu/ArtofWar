...
public class Board {
    ...
    void initBoard() {
        ...
        table[1][5] = new King(new Coordinate(5, 1), TeamColor.BLACK);
        table[8][5] = new King(new Coordinate(5, 8), TeamColor.WHITE);
        table[1][4] = new Queen(new Coordinate(4, 1), TeamColor.BLACK);
        table[8][4] = new Queen(new Coordinate(4, 8), TeamColor.WHITE);
